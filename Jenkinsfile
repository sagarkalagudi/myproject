     ...
     stage('Docker Image Build') {     
        ...
        stage('Docker image push') {
           steps {
                 ...
                 sh "sudo docker image tag myjava-image kalagudisagar/myjava-image:test"
                 sh "sudo docker image tag myjava-image kalagudisagar/myjava-image:${BUILD_NUMBER}"
                 sh "sudo docker image push kalagudisagar/myjava-image:${BUILD_NUMBER}" 
               } 
             }  
          }
      stage('Deploy app') {
